        ...
        <Container>
          <Row>
            ...
            <Col lg="12">
              ...
              {
                tab === 'desc' ? <div className="description__content">
                  <p>{desc}</p>
                  ...
                  {/* <form className="form" onSubmit={submitHandler}>
                    ...
                    <div className="form__group">
                      <textarea rows={5} type="text" placeholder="Enter your description" onChange={e => setReviewMsg(e.target.value)} required/>
                    </div>
